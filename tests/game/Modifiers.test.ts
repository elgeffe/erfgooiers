...
import { BASE_SPEED, BUILD_TIME, CARRY_CAP } from '../../src/constants';
import { Modifiers, hungerFactor } from '../../src/game/Modifiers';
import type { BuildingDef, Unit } from '../../src/types';
