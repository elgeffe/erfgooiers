...
import { makeBuilding, makeCorpse, makeDeco, makeDeposit, makeFieldCrop, makeFish, makePickup, makePig, makeScaffold, makeTree, makeUnit, noOutline, stdMat } from './models';
