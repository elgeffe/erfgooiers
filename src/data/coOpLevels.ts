...
export const EXPEDITION_LEVELS: LevelDef[] = [
  ...
  { index: 1, name: 'Foothold', type: 'Expedition',
    ...
    kit: { stock: { timber: 14, stone: 10, bread: 8, coin: 5 }, serfs: 3, laborers: 1 },
  ...
  { index: 2, name: 'The Network', type: 'Expedition',
    ...
    kit: { stock: { timber: 18, stone: 14, bread: 10, coin: 8 }, serfs: 3, laborers: 1 },
  ...
  { index: 3, name: 'The Warfront', type: 'Expedition',
    ...
    kit: { stock: { timber: 20, stone: 16, bread: 12, coin: 12, weapon: 3 }, serfs: 3, laborers: 1 },
  ...
  { index: 4, name: 'The Expedition Finale', type: 'Expedition',
    ...
    kit: { stock: { timber: 22, stone: 18, bread: 14, coin: 16, weapon: 4, armor: 2 }, serfs: 3, laborers: 1 },
