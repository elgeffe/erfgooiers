...
export const HEROES: HeroDef[] = [
  ...
  { id: 'merchant', name: 'Marcus the Merchant', title: 'Economy hero', icon: '💰',
    ...
    apply: [
      ...
      { stat: 'trainCost', mult: 2, filter: 'ballista' },
      { stat: 'trainCost', mult: 2, filter: 'onager' },
      { stat: 'trainCost', mult: 2, filter: 'trebuchet' },
      { stat: 'trainCost', mult: 2, filter: 'priest' },
    ] },
  ...
  { id: 'warlord', name: 'Wolter the Warlord', title: 'War hero', icon: '⚔️',
    ...
    apply: [
      ...
      { stat: 'combat:damage', mult: 1.2, filter: 'pikeman' },
