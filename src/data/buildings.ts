...
export const DEFS: Record<BuildingKey, BuildingDef> = {
  storehouse: { name: 'Storehouse', desc: 'Stores every good', style: 'storehouse', model: 'castle',
    cost: {}, roof: 0x9a3b2e, wall: 0xb3aea2, store: true, hp: 500 },

  guildhall: { name: 'Guild Hall', desc: 'Trains villagers who staff your buildings (also serfs & builders)', style: 'guildhall', model: 'guildhall',
  ...
  woodcutter: { name: "Woodcutter's Hut", desc: 'Chops nearby trees → trunks', style: 'woodcutter', model: 'cottage',
  ...
  forester: { name: "Forester's Lodge", desc: 'Plants new trees nearby', style: 'forester', model: 'cottage',
  ...
  sawmill: { name: 'Sawmill', desc: 'Trunks → timber', style: 'sawmill', model: 'cottage',
  ...
  quarry: { name: 'Quarry', desc: 'Mines stone deposits', style: 'quarry', model: 'mine',
  ...
  farm: { name: 'Farm', desc: 'Grows & harvests wheat on its plots', style: 'farm', model: 'farm',
  ...
  mill: { name: 'Mill', desc: 'Wheat → flour', style: 'mill', model: 'windmill',
    cost: { timber: 2, stone: 2 }, roof: 0x8a7550, wall: 0xece3cf,
    recipe: { inp: { wheat: 1 }, out: 'flour', time: 5 }, worker: 'Miller', wcolor: 0xcabb9a },

  bakery: { name: 'Bakery', desc: 'Flour → bread', style: 'bakery', model: 'cottage',
  ...
  goldmine: { name: 'Gold Mine', desc: 'Mines gold ore deposits', style: 'goldmine', model: 'mine',
  ...
  coalmine: { name: 'Coal Mine', desc: 'Mines coal deposits', style: 'coalmine', model: 'mine',
  ...
  mint: { name: 'Mint', desc: 'Gold ore + coal → coins', style: 'mint', model: 'cottage',
  ...
  vineyard: { name: 'Vineyard', desc: 'Grows & harvests grapes on its plots', style: 'vineyard', model: 'farm',
  ...
  winery: { name: 'Winery', desc: 'Grapes → wine', style: 'winery', model: 'cottage',
  ...
  pigfarm: { name: 'Pig Farm', desc: 'Pigs graze pasture plots → meat', style: 'pigfarm', model: 'farm',
  ...
  butcher: { name: 'Butchery', desc: 'Meat → sausages', style: 'butcher', model: 'cottage',
  ...
  tavern: { name: 'Tavern', desc: 'Serves any food (bread, sausage, wine, fish…) to keep workers fed & fast', style: 'tavern', model: 'tavern',
  ...
  fishery: { name: 'Fishery', desc: 'Nets fish from the lake — build on the shore', style: 'fishery', model: 'cottage',
  ...
  ironmine: { name: 'Iron Mine', desc: 'Mines iron deposits — the raw metal for weapons & armor', style: 'ironmine', model: 'mine',
  ...
  smithy: { name: 'Weaponsmith', desc: 'Iron + coal → weapons for training soldiers & knights', style: 'smithy', model: 'cottage',
  ...
  armory: { name: 'Armorer', desc: 'Iron + coal → armor for training knights', style: 'armory', model: 'cottage',
  ...
  barracks: { name: 'Barracks', desc: 'Trains soldiers, archers & knights — weapons come from the smithy', style: 'barracks', model: 'barn',
  ...
  watchtower: { name: 'Watchtower', desc: 'Looses arrows at raiders in range — build it along their path', style: 'watchtower', model: 'mine',
    cost: { timber: 2, stone: 5 }, roof: 0x6a7076, wall: 0x9aa0a3, accent: 0x3f5aa0, hp: 320,
    tower: { range: 7, dmg: 9, rate: 1.4 } },

  banditcamp: { name: 'Bandit Camp', desc: 'A den of raiders', style: 'banditcamp', model: 'barn',
    cost: {}, roof: 0x4a2e20, wall: 0x6b4a34, accent: 0x3a2a20, hp: 180 },

  enemywatchtower: { name: 'Watchtower', desc: 'A fortified enemy archer tower', style: 'enemywatchtower', model: 'mine',
    cost: {}, roof: 0x4a5056, wall: 0x777d82, accent: 0x9c3b3b, hp: 260,
    tower: { range: 6.5, dmg: 9, rate: 1.6 } },

  enemycastle: { name: 'Enemy Keep', desc: 'The enemy stronghold', style: 'enemycastle', model: 'castle',
