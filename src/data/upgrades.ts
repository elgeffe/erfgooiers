...
export const UPGRADES: UpgradeDef[] = [
  { id: 'swift-serfs', name: 'Swift Serfs', desc: 'Serfs haul 20% faster', pool: 'economy', basePrice: 18,
    apply: [{ stat: 'unitSpeed', mult: 1.2, filter: 'serf' }] },

  { id: 'quick-feet', name: 'Quick Feet', desc: 'All workers move 12% faster', pool: 'economy', basePrice: 22,
    apply: [{ stat: 'unitSpeed', mult: 1.12 }] },

  { id: 'master-builders', name: 'Master Builders', desc: 'Buildings raise 25% faster', pool: 'economy', basePrice: 20,
    apply: [{ stat: 'buildTime', mult: 0.75 }] },

  { id: 'sharp-tools', name: 'Sharp Tools', desc: 'Gathering is 18% faster', pool: 'economy', basePrice: 24,
    apply: [{ stat: 'gatherTime', mult: 0.82 }] },

  { id: 'busy-workshops', name: 'Busy Workshops', desc: 'Crafting is 18% faster', pool: 'economy', basePrice: 24,
    apply: [{ stat: 'recipeTime', mult: 0.82 }] },

  { id: 'deep-veins', name: 'Deep Veins', desc: 'Mining stone, gold & coal 25% faster', pool: 'economy', basePrice: 26,
    apply: [
  ...
  { id: 'fertile-fields', name: 'Fertile Fields', desc: 'Crops grow 35% faster', pool: 'economy', basePrice: 20,
    apply: [{ stat: 'fieldGrowth', mult: 1.35 }] },

  { id: 'cheap-timber', name: 'Thrifty Framing', desc: 'Buildings cost 1 less timber', pool: 'economy', basePrice: 16,
    apply: [{ stat: 'cost:timber', add: -1 }] },

  { id: 'coin-clipper', name: 'Coin Clipper', desc: '+25% gold from all sources', pool: 'economy', basePrice: 28,
    apply: [{ stat: 'goldGain', mult: 1.25 }] },

  { id: 'extra-hand', name: 'Extra Hand', desc: 'Start each level with +1 laborer', pool: 'economy', basePrice: 22,
    apply: [{ stat: 'extraLaborer', add: 1 }] },

  { id: 'extra-serf', name: 'Willing Hands', desc: 'Start each level with +1 serf', pool: 'economy', basePrice: 22,
    apply: [{ stat: 'extraSerf', add: 1 }] },

  { id: 'well-fed', name: 'Full Larder', desc: 'Start each level with +4 bread', pool: 'economy', basePrice: 14,
    apply: [{ stat: 'startBread', add: 4 }] },

  { id: 'stout-stores', name: 'Stout Stores', desc: 'Start with +3 timber & +3 stone', pool: 'economy', basePrice: 18,
